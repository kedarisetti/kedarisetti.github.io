...
![The mechanism, using the patent's own example.](mechanism-flow.svg){fig-alt="Six-panel storyboard. Panel one, a camera is already watching when the incident happens in its view. Panel two, it records everything and does nothing, having no way to know it matters. Panel three, minutes later someone safe calls 911 with the incident's time and place. Panel four, the call points back into the camera's recording and software tags what it saw with the words explosion, fire, car, people, scream. Panel five, the tags are tied back to the camera as an armed tripwire: if a new clip's tags share at least four of the five words, a staged response is ready, notify responders' radios, alert the call taker, open doors, sound sirens. Panel six, the camera keeps tagging what it sees, and when the tags match, the response starts on its own, no one has to call."}
